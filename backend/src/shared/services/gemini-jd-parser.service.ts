...
3. IGNORE the following (do NOT create rules for these):
...
4. Group similar skills together (e.g., "JavaScript, TypeScript, React" → "Core Technical Skills")

5. Keep chunks atomic and matchable (e.g., "React" not "experience with React")
